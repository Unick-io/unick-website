                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="7a3e7f71-b68c-4652-9d27-571e3735beae"
                        {...register("apikey")}
                      />
                      <input
                        type="hidden"
                        value={`${userName} sent a message from Unick.io`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="Unick.io Contact Form"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : "border-gray-300 focus:border-purple-600 ring-purple-100"
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className={`w-full px-3 py-2 placeholder-gray-300 bg-white text-gray-600 border border-gray-300 rounded-md h-28 focus:outline-none focus:ring   ${
                            errors.message
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-purple-600 ring-purple-100"
                          }`}
